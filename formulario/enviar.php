                ...
                <td align='center' valign='top'>
                    <table width='694' border='0' align='center' cellpadding='0' cellspacing='0'>
                        <tbody>
                            <tr>
                                <td align='right'>
                                    <img src='http://meusite/images/logo.png' width='250' height='100' alt='Logomarca'>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
$mail->Username = 'email@dominiodosite.com.br'; // Usuário do servidor SMTP (endereço de email)
...
$mail->From = "email@dominiodosite.com.br"; // Seu e-mail

$mail->Sender = "email@dominiodosite.com.br"; // Seu e-mail

$mail->FromName = "Nome da Sua Empresa"; // Seu nome
...
$mail->AddAddress('email@dominiodosite.com.br', 'Nome da Sua Empresa');
...
if ($enviado) { ?>
    <script language="javascript" type="text/javascript">
        ...
        window.location = '../nome-da-pagina';
    </script>
<?php
}
else { ?>
